...
// +-------------------------------------------------+
// $Id: expl.class.php,v 1.89.2.2 2017-12-12 10:42:53 ngantier Exp $
				...
				$supprimer = "
					<script type=\"text/javascript\">
						function confirm_delete() {
							...
							if(result) document.location = \"./catalog.php?categ=del_expl&id=".$this->id_notice."&cb=".urlencode($this->cb)."&expl_id=".$this->expl_id."\";
							else unload_on();
						}
					</script>
