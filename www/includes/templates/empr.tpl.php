...
// +-------------------------------------------------+
// $Id: empr.tpl.php,v 1.176.2.6 2018-02-13 15:04:03 jpermanne Exp $
...
<div id=\"el!!id!!Parent\" class=\"notice-parent\">
   		<h1 id='empr-name'><div class='left'><img src=\"./images/plus.gif\" class=\"img_plus\" name=\"imEx\" id=\"el!!id!!Img\" title=\"".$msg['admin_param_detail']."\" border=\"0\" onClick=\"expandBase('el!!id!!', true); return false;\">
   		!!image_caddie_empr!! <span class='empr-name h3-like'>!!prenom!! !!nom!!</span> <font size='2'>".$msg['empr_nb_pret'].": !!info_nb_pret!! ".$msg['empr_nb_resa'].": !!info_nb_resa!! !!info_resa_planning!! !!header_format!!</font></div><div class='right'><font size='2'>!!empr_resume!! !!empr_statut_libelle!!</font></div></h1>
   		</div>
...
<div class='row'>
	<div class='left' id='empr_form_actions_buttons'>
		...
		<input type='button' id='imprimercarte' name='imprimercarte' class='bouton' value='".$msg['imprimer_carte']."' onClick=\"openPopUp('./pdf.php?pdfdoc=carte-lecteur&id_empr=!!id!!', 'print_PDF', 600, 500, -2, -2, '$PDF_win_prop');\" />";
...
if ($pmb_form_editables==1) {
	...
	<div class='form-contenu'>
		...
		<div class='form-empr-fgrp ui-clearfix' id='g0'>
			...
			<div class='row' id='g0_r1' etirable='yes' recept='yes' recepttype='circrow' highlight='circrow_highlight' downlight='circrow_downlight' >
				...
				<div class='colonne_suite' id='g0_r1_f2' movable='yes' title='".$msg[72]."' draggable='yes' dragtype='circcell' recept='yes' recepttype='circcell' highlight='circcell_highlight' downlight='circcell_downlight'>
					...
					<div class='row'>
						...
						<input type='button'  class='bouton' value='".$msg['parcourir']."' onclick=\"var scp = this.form.form_cp.value; if(!this.form.form_cp.value) { scp=this.form.form_ville.value; } openPopUp('./select.php?what=codepostal&caller=empr_form&param1=form_ville&param2=form_cp&deb_rech='+".pmb_escape()."(scp), 'select_codepostal', 400, 400, -2, -2, '$select1_prop')\" />
					</div>
				</div>
				<div class='row'></div>
			</div>
		...
		<div class='form-empr-fgrp ui-clearfix' id='g1' >	
		...
		<div class='form-empr-fgrp ui-clearfix' id='g2' >
		...
		<div class='form-empr-fgrp ui-clearfix' id='g3' >
		...
		<div class='form-empr-fgrp ui-clearfix' id='g4'>
		...
		<div class='form-empr-fgrp ui-clearfix' id='g5' >
		...
		<div class='form-empr-fgrp ui-clearfix' id='g6' >	
		...
		<div class='form-empr-fgrp ui-clearfix' id='g7' >
